    ...
    <div className="missionpagecontainer">
      ...
      <div className="missionparagraphcontainer">
        ...
        <p className="missionparagraph">
          ...
          merkezimizin de bulunduğu poşet imalatı yapılan 3000 metrekare kapalı
          alanı bulunan fabrikası ve geri dönüşüm hammaddesinin işlendiği 1500
          metrekare kapalı alanı bulunan şubesi olmak üzere iki farklı mekânda
          toplam 4500 metrekare kapalı alanda deneyimli personelleriyle hizmet
          vermektedir.
        </p>
      </div>
    </div>
